...
class Network(minitorch.Module):
    def __init__(self, hidden_layers):
        ...
        self.layer1 = Linear(2, hidden_layers)  # Input layer (2 inputs to hidden layer)
        self.layer2 = Linear(hidden_layers, hidden_layers)  # Hidden to hidden layer
        self.layer3 = Linear(hidden_layers, 1)  # Hidden to output (1 output)
...
class Linear(minitorch.Module):
    ...
    def forward(self, inputs):
        # TODO: Implement for Task 1.5.
        # Perform the linear transformation (Wx + b)
        output = []
